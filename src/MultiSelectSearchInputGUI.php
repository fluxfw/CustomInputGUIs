...
class MultiSelectSearchInputGUI extends ilMultiSelectInputGUI {
	...
	public function __construct(/*string*/
		...
		self::dic()->template()->addJavaScript(__DIR__ . "/../node_modules/select2/dist/js/select2.min.js");
		self::dic()->template()->addJavaScript(__DIR__ . "/../node_modules/select2/dist/js/i18n/" . self::dic()->user()->getCurrentLanguage()
			. ".js");
		self::dic()->template()->addCss(__DIR__ . "/../node_modules/select2/dist/css/select2.min.css");
